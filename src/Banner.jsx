        ...
        <section className="mt-10 lg:flex lg:justify-center lg:items-end">
            ...
            <div>
                ...
                <div className="flex justify-center">
                    ...
                    <span className="flex justify-center items-center text-zinc-900 dark:text-white text-2xl"><a href="https://github.com/Jonhatan20" className="transition-all duration-200 hover:text-amber-600 hover:scale-125"><FontAwesomeIcon icon={faGithub}/></a></span>
                </div>
            </div>
        </section>
     );
